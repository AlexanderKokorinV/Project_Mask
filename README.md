...
Логирование включает:
   ...
   *Пример использования декоратора log:*
         ...
         ```
6. В текущей версии проекта добавлены 2 новых модуля со следующими функциями:\
    Модуль utils, содержащий функцию get_transactions_from_json. Данная функция принимает на вход путь до JSON-файла и возвращает список словарей с данными
   ...
   ```
    Модуль external_api, содержащий функцию get_amount_in_rubles. Функция принимает на вход транзакцию и возвращает сумму транзакции в рублях (тип данных: float).
