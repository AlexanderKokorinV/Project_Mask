...
from tests.conftest import operation_data
...
def test_sort_by_date(operation_data, ascending=False):
...
def test_sort_by_date(operation_data_same_date, ascending=False):
...
@pytest.mark.parametrize("operation_list, ascending, expected",
    [
...
def test_sort_by_date_par(operation_list, ascending, expected):
