...
def test_mask_account_card_par(card: str, expected: str) -> None:
...
def test_mask_account_par(account_number: str, expected: str) -> None:
...
def test_get_date_par(date_str: str, expected: str) -> None:
    """Тест работы функции при различных параметрах, вызывающих ошибку"""
