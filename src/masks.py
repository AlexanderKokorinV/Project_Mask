...
def get_mask_card_number(card_number: str) -> str:
    ...
    if card_number.isdigit() and len(card_number) == 16:
        ...
        masks_logger.info(f"Принимаем на вход номер карты {card_number} и возвращаем его в замаскированном виде {mask_number}")
    else:
...
def get_mask_account(account: str) -> str:
    ...
    if account.isdigit() and len(account) == 20:
        ...
        masks_logger.info(f"Принимаем на вход номер банковского счета {account} и возвращаем его а замаскированном виде {mask_account}")
    else:
